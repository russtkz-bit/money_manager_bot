LANGUAGES = {
    ...
    "ru": {
        # General
        "welcome": "👋 Добро пожаловать в *Money Manager Bot*!\n\nЯ помогаю отслеживать доходы и расходы, ставить финансовые цели, и мониторить курсы валют. Если вам интересны обновления, то можете подписаться на канал @lookatpatch. \n\nПожалуйста, выберите язык / Please choose your language:",
